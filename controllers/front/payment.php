 ...
 * @since 1.5.0
 */
class SelleragreepaymentPaymentModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		$this->context->smarty->assign(array(
			...
			'confirm_url' => $this->context->link->getModuleLink('selleragreepayment', 'validation', [], true),
